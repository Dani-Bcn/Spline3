...
import { useGLTF, RoundedBox, MeshReflectorMaterial, useCursor, Text3D, useScroll } from "@react-three/drei";
  ...
  return (
    ...
    >
      <group
        ref={groupRef}
        position={[0, 0, 0]}>
        <group scale={[0.006, 0.0045, 0.0045]}
          position={[0, 1.6, 0]}
        ...
        <group scale={[0.006, 0.0045, 0.005]}
          position={[0, 0.1, 0]}
